...
from src.storage import store_pipeline_run
        ...
        try:
            ...
            try:
                store_pipeline_run(
                    ...
                    ranked=ranked,
                    trade_plan=trade_plan,
                    report_payload=pipeline_status,
                )
            except Exception as exc:
                print(f"Avertissement: échec de l'enregistrement en base ({exc}). Le pipeline continue normalement.")
